...
PROFILES: list[ComponentProfile] = [
    ...
    ComponentProfile(
        manufacturer="Texas Instruments",
        orderable_mpn="INA219AIDCNR",
        functional_class=FunctionalClass.SENSOR,
        symbol_ref="Sensor_Current:INA219",
        footprint_ref="Package_TO_SOT_SMD:SOT-23-8",
        pins=[
            Pin(number="1", name="A1", electrical_role=ElectricalRole.DIGITAL_IN, interface_role="i2c_addr1", voltage_domain="3V3"),
            Pin(number="2", name="A0", electrical_role=ElectricalRole.DIGITAL_IN, interface_role="i2c_addr0", voltage_domain="3V3"),
            Pin(
                number="3",
                name="SDA",
                electrical_role=ElectricalRole.OPEN_DRAIN,
            ...
            Pin(number="5", name="VS", electrical_role=ElectricalRole.POWER_IN, voltage_domain="3V3"),
            Pin(number="6", name="GND", electrical_role=ElectricalRole.GROUND, voltage_domain="GND"),
            Pin(number="7", name="IN+", electrical_role=ElectricalRole.ANALOG_IN, interface_role="shunt_p", voltage_domain="BUS"),
            Pin(number="8", name="IN-", electrical_role=ElectricalRole.ANALOG_IN, interface_role="shunt_n", voltage_domain="BUS"),
        ],
        absolute_maximum=[
            Constraint(name="vs", operator="lte", value=6.0, unit="V"),
            Constraint(name="bus_common_mode", operator="lte", value=26, unit="V"),
        ],
        recommended_operating=[
            Constraint(name="vs", operator="between", value=[3.0, 5.5], unit="V"),
            Constraint(name="bus_voltage", operator="between", value=[0, 26], unit="V"),
        ],
        supply_domains=["3V3", "BUS", "GND"],
        required_support_components=[
            "i2c_pullup_sda_4k7",
            "i2c_pullup_scl_4k7",
            "vs_decoupling_100nF",
            "shunt_resistor_rsense",
        ],
        recommended_support_components=["filter_caps_on_inplus_inminus"],
        boot_reset_config=["A0/A1 strapping selects one of 16 I2C addresses"],
        interface_characteristics={
            "bus": "I2C up to 2.56 MHz Fast Mode+",
            "measure": "bus voltage + shunt current / power",
        },
        approved_reference_circuits=["ti:ina219_evm"],
        simulation_model_refs=[],
        evidence_refs=[
            EvidenceRef(
                id="ds:ina219",
                ...
                uri="https://www.ti.com/lit/ds/symlink/ina219.pdf",
                page=1,
                confidence=0.85,
            )
        ],
    ...
    ComponentProfile(
        ...
        orderable_mpn="VL53L0CXV0DH/1",
        functional_class=FunctionalClass.SENSOR,
        symbol_ref="Sensor_Distance:VL53L0X",
        footprint_ref="Package_LGA:ST_LGA-12_4.4x2.4mm_P0.8mm",
        pins=[
            Pin(number="1", name="AVDDVCSEL", electrical_role=ElectricalRole.POWER_IN, voltage_domain="2V8"),
            Pin(number="2", name="AVSSVCSEL", electrical_role=ElectricalRole.GROUND, voltage_domain="GND"),
            Pin(number="3", name="GND", electrical_role=ElectricalRole.GROUND, voltage_domain="GND"),
            Pin(number="4", name="GND2", electrical_role=ElectricalRole.GROUND, voltage_domain="GND"),
            Pin(number="5", name="XSHUT", electrical_role=ElectricalRole.ENABLE, voltage_domain="2V8"),
            Pin(number="6", name="GND3", electrical_role=ElectricalRole.GROUND, voltage_domain="GND"),
            Pin(number="7", name="GPIO1", electrical_role=ElectricalRole.OPEN_DRAIN, interface_role="interrupt", voltage_domain="2V8"),
            Pin(number="8", name="DNC", electrical_role=ElectricalRole.NO_CONNECT),
            Pin(
                number="9",
                name="SDA",
                electrical_role=ElectricalRole.OPEN_DRAIN,
            ...
            Pin(number="11", name="AVDD", electrical_role=ElectricalRole.POWER_IN, voltage_domain="2V8"),
            Pin(number="12", name="GND4", electrical_role=ElectricalRole.GROUND, voltage_domain="GND"),
        ],
        absolute_maximum=[
            Constraint(name="avdd", operator="lte", value=3.0, unit="V"),
        ],
        recommended_operating=[
            Constraint(name="avdd", operator="between", value=[2.6, 3.5], unit="V"),
        ],
        supply_domains=["2V8", "GND"],
        required_support_components=[
            "avdd_decoupling_1uF_and_100nF",
            "avddvcsel_decoupling_1uF_and_100nF",
            "i2c_pullup_sda_4k7",
            "i2c_pullup_scl_4k7",
        ],
        recommended_support_components=["xshut_pullup_10k", "gpio1_pullup_10k"],
        boot_reset_config=["XSHUT low holds device in reset/hardware standby"],
        interface_characteristics={
            "bus": "I2C default address 0x29",
            "sense": "Time-of-Flight ranging up to ~2 m",
        },
        approved_reference_circuits=["st:vl53l0x_nucleo"],
        simulation_model_refs=[],
        evidence_refs=[
            EvidenceRef(
                id="ds:vl53l0x",
                ...
                uri="https://www.st.com/resource/en/datasheet/vl53l0x.pdf",
                page=1,
                confidence=0.85,
            )
        ],
